...
func (e *ScriptExecutor) ExecuteScript(ctx context.Context, script []byte, args [][]byte, block *flow.Header, snapshot FVMStorageSnapshot) ([]byte, error) {
	header, err := e.blocks.ByHeightFrom(block.Height, block)
