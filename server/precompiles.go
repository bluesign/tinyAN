...
type PrecompiledRequirements interface {
...
func PreparePrecompiledContracts(
	...
	backend PrecompiledRequirements,
...
func blockHeightProvider(backend environment.BlockInfo) func() (uint64, error) {
...
func randomSourceProvider(contractAddress flow.Address, backend environment.ContractFunctionInvoker) func(uint64) ([]byte, error) {
...
func revertibleRandomGenerator(backend environment.RandomGenerator) func() (uint64, error) {
	return func() (uint64, error) {
		rand := make([]byte, 8)
...
func coaOwnershipProofValidator(contractAddress flow.Address, backend environment.ContractFunctionInvoker) func(proof *types.COAOwnershipProofInContext) (bool, error) {
