module github.com/bluesign/tinyAN
...
require (
	...
	github.com/peterargue/execdata-client v0.0.0-00010101000000-000000000000
...
replace github.com/peterargue/execdata-client => ../execdata-client
